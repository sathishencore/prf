...
?>
	...
	<tr>
		<td colspan="8" style="text-align: center" class="headerRight">No
		Records found</td>
	</tr>
		...
		if(x){
            ...
            users += "<tr><td style='font-weight: bold;font-size:14px;color: #be5e00;'>Project</td><td style='font-weight: bold;font-size:14px;color: #be5e00;'>Position</td><td style='font-weight: bold;font-size:14px;color: #be5e00;'>Select Recruiter</td></tr>";
              ...
              //   alert(proname);
                  ...
                  // users += "<tr><td style='font-weight: bold;font-size:14px;'>Position</td>";
                  //   users += "<td>:</td>";  users += "<td></td>";
                  //users += "<td></td>";
                 }
			...
			if($(this).attr("title")=='Inactivate'){
				//alert($(this).attr("title"));
				 ...
				 dataType: "json",
					...
					for(x in arr1) {
						if(arr1[x]!=result_acc[0].EncoreContacts['ContactName']) {
					...
					//users_acc += "<tr><td style='font-weight: bold;font-size:14px;'>Project&nbsp;Name</td>";
		                 ...
		                 var f;
		                  ...
		                  users_acc += "<td><input type='hidden' value='"+result_acc[i].EncoreContacts['ID']+"' name='enc_id' ></td>";
		                  users_acc += "<td><input type='hidden' value='"+result_acc[0].EncoreContacts['ContactName']+"' name='enc_name' ></td>";
		                  users_acc += "<td><input type='hidden' value='"+result_acc[0].EncoreContacts['Email']+"' name='enc_mail' ></td>";
		                  users_acc += "</tr>";
		                  f = i+1; 
