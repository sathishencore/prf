<div class="titlebg">
	<div class="titletxt">Forecast Summary Report</div>	
</div>
...
<div class="bodyconrarea">
	...
	<?php echo $this->Form->create("SummarytFrm",array("url"=>array("controller"=>"Report", "action"=>"summary")));?>
	...
	<div class="displayResults">
		<?php echo $this->element("forecast_summary"); ?>						
	</div>
	<div class="clear">&nbsp;</div>
