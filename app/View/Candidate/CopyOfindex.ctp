								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="4"
										...
										<tr>
											...
											<td style="width: 10%;">Role<span class="errorMandatory">*</span></td>
											<td>:</td>
										...
										<tr>
											...
											<td>:</td>
											<td><?php echo $this->Form->input("Candidate.HighestEducationLevel",array("label"=>false,"class"=>"textfield-cmn textfield-cmn-small","div"=>false,"tabindex"=>"16"));?>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td>Relocation Req ?<span class="errorMandatory">*</span>
											</td>
											<td>:</td>
											...
											<td rowspan="2">Interview Comments</td>
											<td rowspan="2">:</td>
										...
										<tr>
											<td style="width: 10%;">DOB
											</td>
											<td>:</td>
											<td><?php echo $this->Form->input("Candidate.DateOfBirth1",array("label"=>false,"class"=>"textfield-cmn textfield-cmn-small dobDatepicker","div"=>false,"value"=>$DOB,"tabindex"=>"12"));?>
											</td>
											<td colspan="3"></td>
										</tr>
										<tr>
											...
											<td style="text-align: left;" colspan=4><?php echo $this->Form->file("Candidate.ResumeNames",array("label"=>false,"style"=>"float:left","div"=>false,"tabindex"=>"27"));?></td>
											<?php }?>
											<td class="browseFile" style="text-align: left;" colspan=4><?php echo $this->Form->file("Candidate.ResumeNames",array("label"=>false,"style"=>"float:left","div"=>false,"tabindex"=>"27"))." ".
											$this->Html->link("hide",array(),array("onclick"=>"return existingResume()","style"=>"margin-left:-16%"));?></td>
										</tr>
									 </table>
								</td>
							</tr>
