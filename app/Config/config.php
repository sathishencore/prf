...
$config['Client']['addClientContact'] = 'Client Contact created successfully';
...
$config['User']['addEncoreContact'] = 'Encore Contact created successfully';
$config['User']['updateEncoreContact'] = 'Encore Contact updated successfully';
$config['User']['addEncoreContactFailure'] = 'Cannot save new contact';
$config['User']['deleteEncoreContactSuccess'] = 'Encore Contact details deleted successfully';
$config['User']['deleteEncoreContactFailure'] = 'The encore contact has one or more associated projects and cannot be deleted';
...
$config['Candidate']['ResourceType']=array("Salary with Benefits" => "Salary with Benefits",
												"Salary without Benefits"=>"Salary without Benefits",
												"Corp-to-Corp"=>"Corp-to-Corp",
										);

$config['Candidate']['Compensation']=array("W2 - Salary" => "W2 - Salary",
											"W2 - Hourly" => "W2 - Hourly",
											"Corp-to-Corp" => "Corp-to-Corp",
										);	
...
$config['AUTH_KEY'] = 'encwfefrgtegedfsegretreertretret';
$config['AUDIENCE'] = '015f481acfe402c9bae435389efbb6914929bf8c';
$config['ISSUER'] = 'onelogin.encoress.com';
